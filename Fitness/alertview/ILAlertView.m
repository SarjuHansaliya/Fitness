 ...
 * untouched.
 */
#define kILAlertViewTitleColor [UIColor colorWithRed:223.0/255.0 green:117.0/255.0 blue:3.0/255.0 alpha:1.0]
#define kILAlertViewMessageColor [UIColor blackColor]
#define kILAlertViewCloseButtonColorSelected [UIColor blackColor]
#define kILAlertViewCloseButtonColor kILAlertViewTitleColor
#define kILAlertViewSecondButtonColorSelected [UIColor blackColor]
#define kILAlertViewSecondButtonColor kILAlertViewTitleColor
            ...
            tappedSecondButton:(void(^)(void))block;
{
    ...
    if (self) {
        ...
        if (secondTitle) {
           ...
           // [_secondButton setBackgroundColor:[UIColor colorWithRed:254.0/255.0 green:247.0/255.0 blue:235.0/255.0 alpha:1.0]];
       ...
       // [_closeButton setBackgroundColor:[UIColor colorWithRed:254.0/255.0 green:247.0/255.0 blue:235.0/255.0 alpha:1.0]];
